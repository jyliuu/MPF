...
mpf_boosted, mpf_fr = mpf_py.MPFBoosted.fit(x_train, y_train, epochs = 10, B = 100, n_iter = 100, split_try = 10, colsample_bytree = 1.0)
end_time = time.time()  # End timing for TreeGrid
print("MPFBoosted fitting time: ", end_time - start_time, "seconds")
...
mpf_error = np.mean((mpf_boosted.predict(x_test) - y_test) ** 2)
